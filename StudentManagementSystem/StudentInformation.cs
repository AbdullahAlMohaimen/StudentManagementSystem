    ...
    public partial class StudentInformation : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand command = new SqlCommand("Update Student set student_Address='" + address + "',student_PhoneNo='" + phoneNo + "', student_Passeord='"+password+"' where student_ID='" + id + "'", conn);
